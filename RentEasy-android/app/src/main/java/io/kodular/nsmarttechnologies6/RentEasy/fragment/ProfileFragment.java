...
import io.kodular.nsmarttechnologies6.RentEasy.activity.LanguagePickerActivity;
import io.kodular.nsmarttechnologies6.RentEasy.activity.LoginActivity;
import io.kodular.nsmarttechnologies6.RentEasy.activity.MyPostingsActivity;
...
public class ProfileFragment extends Fragment implements View.OnClickListener {
    ...
    private void init() {
        ...
        io.RentEasy.views.MediumTextView goProBtn = rootView.findViewById(R.id.tv_goPro);
        ...
        CardView cvLikedAds = rootView.findViewById(R.id.cv_liked_ads);
        ...
        ImageView ivTwitter = rootView.findViewById(R.id.iv_linkedin);
        ImageView ivyt = rootView.findViewById(R.id.iv_youtube);
        ImageView ivLinkedIN = rootView.findViewById(R.id.iv_linkedIn);
        ImageView ivLanguage = rootView.findViewById(R.id.iv_language);
        io.RentEasy.views.MediumTextView ProBtn = rootView.findViewById(R.id.tv_goPro);

        backLay.setOnClickListener(this);
        cvMyProperty.setOnClickListener(this);
        cvLikedAds.setOnClickListener(this);
    ...
    private void shareIntent() {
        ...
        sendIntent.putExtra(Intent.EXTRA_TEXT, "Hey! I Suggest RentEasy App to Find or Post anything for Rent. Click below to download app. "+ appLink);
    ...
    private void openEmail() {
        try {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("mailto:" + "your-email@example.com"));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.cv_my_property:
                Utils.startActivity(mActivity, MyPostingsActivity.class);
                break;
            case R.id.cv_liked_ads:
            ...
            case R.id.cv_contact_us:
                ...
                builder.setMessage("Contact us via")
                        .setCancelable(false)
                        .setPositiveButton("WhatsApp", (dialog, id) -> {
                            gotoUrl("https://api.whatsapp.com/send?phone=+91-9381215220&text=I want to rent your posting.");
                        })
                        .setNegativeButton("Mail", (dialog, id) -> openEmail());
                AlertDialog alert = builder.create();
                alert.show();
                break;
            case R.id.cv_logout:
            ...
            case R.id.iv_linkedin:
                gotoUrl("https://www.linkedin.com/company/72757450/admin/");
                break;
            ...
            case R.id.iv_youtube:
                gotoUrl("https://www.youtube.com/channel/UCSIeDfzuLDlxGbquvIAK1TA");
                break;
            case R.id.iv_linkedIn:
            ...
            case R.id.iv_language:
                ...
                Utils.startActivity(mActivity, LanguagePickerActivity.class);
                break;
            default:
        }
    }
